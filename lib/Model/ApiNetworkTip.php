...
/**
 * ApiNetworkTip Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ApiNetworkTip implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiNetworkTip';
    ...
    public function setSlotNumber($slot_number)
    {
        ...
        if (($slot_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $slot_number when calling ApiNetworkTip., must be bigger than or equal to 0.');
        }
    ...
    public function setEpochNumber($epoch_number)
    {
        ...
        if (($epoch_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $epoch_number when calling ApiNetworkTip., must be bigger than or equal to 0.');
        }
