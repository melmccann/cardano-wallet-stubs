...
class InlineObject4 implements ModelInterface, ArrayAccess
{
    ...
    public function setPassphrase($passphrase)
    {
        if ((mb_strlen($passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling InlineObject4., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($passphrase) < 0)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling InlineObject4., must be bigger than or equal to 0.');
        }
