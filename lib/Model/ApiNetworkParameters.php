 ...
 * @link     https://openapi-generator.tech
 */
class ApiNetworkParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiNetworkParameters';
    ...
    public function setGenesisBlockHash($genesis_block_hash)
    {
        if ((mb_strlen($genesis_block_hash) > 64)) {
            throw new \InvalidArgumentException('invalid length for $genesis_block_hash when calling ApiNetworkParameters., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($genesis_block_hash) < 64)) {
            throw new \InvalidArgumentException('invalid length for $genesis_block_hash when calling ApiNetworkParameters., must be bigger than or equal to 64.');
        }
