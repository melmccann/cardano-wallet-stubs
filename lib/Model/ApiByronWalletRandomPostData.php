...
/**
 * ApiByronWalletRandomPostData Class Doc Comment
 *
 * @category Class
 * @package  melmccann\cardanowallet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ApiByronWalletRandomPostData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiByronWalletRandomPostData';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApiByronWalletRandomPostData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApiByronWalletRandomPostData., must be bigger than or equal to 1.');
        }
    ...
    public function setPassphrase($passphrase)
    {
        if ((mb_strlen($passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling ApiByronWalletRandomPostData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($passphrase) < 10)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling ApiByronWalletRandomPostData., must be bigger than or equal to 10.');
        }
