...
/**
 * ApiStakePool Class Doc Comment
 *
 * @category Class
 * @package  melmccann\cardanowallet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ApiStakePool implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiStakePool';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'metrics' => '\melmccann\cardanowallet\Model\ApiStakePoolMetrics',
    ...
    {
        if ((mb_strlen($id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ApiStakePool., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($id) < 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ApiStakePool., must be bigger than or equal to 64.');
        }
     ...
     * Gets metrics
     *
     * @return \melmccann\cardanowallet\Model\ApiStakePoolMetrics|null
     */
     ...
     * Sets metrics
     *
     * @param \melmccann\cardanowallet\Model\ApiStakePoolMetrics|null $metrics metrics
     *
     * @return $this
     */
