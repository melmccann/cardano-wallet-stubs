<?php
/**
 * ApiStakePoolMetricsProducedBlocks
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ApiStakePoolMetricsProducedBlocks Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ApiStakePoolMetricsProducedBlocks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiStakePool_metrics_produced_blocks';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ApiStakePoolMetricsProducedBlocks., must be bigger than or equal to 0.');
        }
