...
class InlineResponse2021 implements ModelInterface, ArrayAccess
{
    ...
    {
        if ((mb_strlen($id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse2021., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($id) < 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse2021., must be bigger than or equal to 64.');
        }
