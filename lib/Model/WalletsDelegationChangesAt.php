...
/**
 * WalletsDelegationChangesAt Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class WalletsDelegationChangesAt implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_wallets_delegation_changes_at';
    ...
    public function setEpochNumber($epoch_number)
    {
        ...
        if (($epoch_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $epoch_number when calling WalletsDelegationChangesAt., must be bigger than or equal to 0.');
        }
