...
/**
 * ApiByronWalletPutPassphraseData Class Doc Comment
 *
 * @category Class
 * @package  melmccann\cardanowallet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ApiByronWalletPutPassphraseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiByronWalletPutPassphraseData';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['old_passphrase']) && (mb_strlen($this->container['old_passphrase']) > 255)) {
            $invalidProperties[] = "invalid value for 'old_passphrase', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['old_passphrase']) && (mb_strlen($this->container['old_passphrase']) < 0)) {
            $invalidProperties[] = "invalid value for 'old_passphrase', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets old_passphrase
     *
     * @param string|null $old_passphrase The current passphrase if present.
     *
     * @return $this
     */
    public function setOldPassphrase($old_passphrase)
    {
        if (!is_null($old_passphrase) && (mb_strlen($old_passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $old_passphrase when calling ApiByronWalletPutPassphraseData., must be smaller than or equal to 255.');
        }
        if (!is_null($old_passphrase) && (mb_strlen($old_passphrase) < 0)) {
            throw new \InvalidArgumentException('invalid length for $old_passphrase when calling ApiByronWalletPutPassphraseData., must be bigger than or equal to 0.');
        }
    ...
    public function setNewPassphrase($new_passphrase)
    {
        if ((mb_strlen($new_passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $new_passphrase when calling ApiByronWalletPutPassphraseData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($new_passphrase) < 10)) {
            throw new \InvalidArgumentException('invalid length for $new_passphrase when calling ApiByronWalletPutPassphraseData., must be bigger than or equal to 10.');
        }
