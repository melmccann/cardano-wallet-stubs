...
/**
 * ApiStakePoolMetricsNonMyopicMemberRewards Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ApiStakePoolMetricsNonMyopicMemberRewards implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiStakePool_metrics_non_myopic_member_rewards';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ApiStakePoolMetricsNonMyopicMemberRewards., must be bigger than or equal to 0.');
        }
