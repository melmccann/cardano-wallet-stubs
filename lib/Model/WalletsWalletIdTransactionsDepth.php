...
/**
 * WalletsWalletIdTransactionsDepth Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class WalletsWalletIdTransactionsDepth implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_wallets__walletId__transactions_depth';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling WalletsWalletIdTransactionsDepth., must be bigger than or equal to 0.');
        }
