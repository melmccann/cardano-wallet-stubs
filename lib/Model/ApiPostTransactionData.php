 ...
 * @link     https://openapi-generator.tech
 */
class ApiPostTransactionData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiPostTransactionData';
    ...
    public function setPassphrase($passphrase)
    {
        if ((mb_strlen($passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling ApiPostTransactionData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($passphrase) < 0)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling ApiPostTransactionData., must be bigger than or equal to 0.');
        }
