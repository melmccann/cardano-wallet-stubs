...
/**
 * WalletsBalanceAvailable Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class WalletsBalanceAvailable implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_wallets_balance_available';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling WalletsBalanceAvailable., must be bigger than or equal to 0.');
        }
