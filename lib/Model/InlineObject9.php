...
class InlineObject9 implements ModelInterface, ArrayAccess
{
    ...
    public function setOldPassphrase($old_passphrase)
    {
        if (!is_null($old_passphrase) && (mb_strlen($old_passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $old_passphrase when calling InlineObject9., must be smaller than or equal to 255.');
        }
        if (!is_null($old_passphrase) && (mb_strlen($old_passphrase) < 0)) {
            throw new \InvalidArgumentException('invalid length for $old_passphrase when calling InlineObject9., must be bigger than or equal to 0.');
        }
    ...
    public function setNewPassphrase($new_passphrase)
    {
        if ((mb_strlen($new_passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $new_passphrase when calling InlineObject9., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($new_passphrase) < 10)) {
            throw new \InvalidArgumentException('invalid length for $new_passphrase when calling InlineObject9., must be bigger than or equal to 10.');
        }
