...
/**
 * ApiWalletPutPassphraseData Class Doc Comment
 *
 * @category Class
 * @package  melmccann\cardanowallet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ApiWalletPutPassphraseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiWalletPutPassphraseData';
    ...
    public function setOldPassphrase($old_passphrase)
    {
        if ((mb_strlen($old_passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $old_passphrase when calling ApiWalletPutPassphraseData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($old_passphrase) < 10)) {
            throw new \InvalidArgumentException('invalid length for $old_passphrase when calling ApiWalletPutPassphraseData., must be bigger than or equal to 10.');
        }
    ...
    public function setNewPassphrase($new_passphrase)
    {
        if ((mb_strlen($new_passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $new_passphrase when calling ApiWalletPutPassphraseData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($new_passphrase) < 10)) {
            throw new \InvalidArgumentException('invalid length for $new_passphrase when calling ApiWalletPutPassphraseData., must be bigger than or equal to 10.');
        }
