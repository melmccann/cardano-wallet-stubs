...
class InlineResponse200 implements ModelInterface, ArrayAccess
{
    ...
    {
        if ((mb_strlen($id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse200., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($id) < 40)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse200., must be bigger than or equal to 40.');
        }
    ...
    public function setAddressPoolGap($address_pool_gap)
    {
        ...
        if (($address_pool_gap > 100)) {
            throw new \InvalidArgumentException('invalid value for $address_pool_gap when calling InlineResponse200., must be smaller than or equal to 100.');
        }
        if (($address_pool_gap < 10)) {
            throw new \InvalidArgumentException('invalid value for $address_pool_gap when calling InlineResponse200., must be bigger than or equal to 10.');
        }
