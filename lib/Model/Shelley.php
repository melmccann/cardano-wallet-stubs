 ...
 * @link     https://openapi-generator.tech
 */
class Shelley implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shelley';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Shelley., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Shelley., must be bigger than or equal to 1.');
        }
    ...
    public function setPassphrase($passphrase)
    {
        if ((mb_strlen($passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling Shelley., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($passphrase) < 10)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling Shelley., must be bigger than or equal to 10.');
        }
    ...
    public function setAddressPoolGap($address_pool_gap)
    {
        ...
        if (!is_null($address_pool_gap) && ($address_pool_gap > 100)) {
            throw new \InvalidArgumentException('invalid value for $address_pool_gap when calling Shelley., must be smaller than or equal to 100.');
        }
        if (!is_null($address_pool_gap) && ($address_pool_gap < 10)) {
            throw new \InvalidArgumentException('invalid value for $address_pool_gap when calling Shelley., must be bigger than or equal to 10.');
        }
