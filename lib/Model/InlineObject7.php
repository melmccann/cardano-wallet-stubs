...
class InlineObject7 implements ModelInterface, ArrayAccess
{
    ...
    public function setPassphrase($passphrase)
    {
        if ((mb_strlen($passphrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling InlineObject7., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($passphrase) < 10)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling InlineObject7., must be bigger than or equal to 10.');
        }
