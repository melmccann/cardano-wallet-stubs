...
/**
 * CoinSelectionsApi Class Doc Comment
 *
 * @category Class
 * @package  melmccann\cardanowallet
 * @author   OpenAPI Generator team
...
class CoinSelectionsApi
{
    ...
    /**
     * Operation selectCoins
     *
     * Random
     *
     * @param  string $wallet_id wallet_id (required)
     * @param  \melmccann\cardanowallet\Model\InlineObject6 $inline_object6 inline_object6 (required)
     *
     ...
     */
    public function selectCoins($wallet_id, $inline_object6)
    {
        list($response) = $this->selectCoinsWithHttpInfo($wallet_id, $inline_object6);
        return $response;
    }

    /**
     * Operation selectCoinsWithHttpInfo
     *
     * Random
     *
     * @param  string $wallet_id (required)
     * @param  \melmccann\cardanowallet\Model\InlineObject6 $inline_object6 (required)
     *
     * @throws \melmccann\cardanowallet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function selectCoinsWithHttpInfo($wallet_id, $inline_object6)
    {
        $request = $this->selectCoinsRequest($wallet_id, $inline_object6);
     ...
     */
    public function selectCoinsAsync($wallet_id, $inline_object6)
    {
        return $this->selectCoinsAsyncWithHttpInfo($wallet_id, $inline_object6)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation selectCoinsAsyncWithHttpInfo
     *
     * Random
     *
     * @param  string $wallet_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function selectCoinsAsyncWithHttpInfo($wallet_id, $inline_object6)
    {
        $returnType = '\melmccann\cardanowallet\Model\InlineResponse2004';
        $request = $this->selectCoinsRequest($wallet_id, $inline_object6);
    ...
    /**
     * Create request for operation 'selectCoins'
     *
     * @param  string $wallet_id (required)
     * @param  \melmccann\cardanowallet\Model\InlineObject6 $inline_object6 (required)
     *
     ...
     */
    protected function selectCoinsRequest($wallet_id, $inline_object6)
    {
        // verify the required parameter 'wallet_id' is set
        if ($wallet_id === null || (is_array($wallet_id) && count($wallet_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wallet_id when calling selectCoins'
            );
        }
        if (strlen($wallet_id) > 40) {
            throw new \InvalidArgumentException('invalid length for "$wallet_id" when calling CoinSelectionsApi.selectCoins, must be smaller than or equal to 40.');
        }
        if (strlen($wallet_id) < 40) {
            throw new \InvalidArgumentException('invalid length for "$wallet_id" when calling CoinSelectionsApi.selectCoins, must be bigger than or equal to 40.');
        }

        // verify the required parameter 'inline_object6' is set
        if ($inline_object6 === null || (is_array($inline_object6) && count($inline_object6) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inline_object6 when calling selectCoins'
            );
        }

        $resourcePath = '/wallets/{walletId}/coin-selections/random';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
